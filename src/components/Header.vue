...
<nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
    ...
    <div class="hidden lg:flex lg:gap-x-12">
        ...
        <a href="/champions" class="text-sm font-semibold leading-6 text-white">Champions</a>
...
<div class="lg:hidden" role="dialog" aria-modal="true">
    ...
    <div class="mt-6 flow-root">
        ...
        <div class="space-y-2 py-6">
            ...
            <a href="/champions" class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-white hover:bg-gray-800">Champions</a>
            <a href="/about" class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-white hover:bg-gray-800">About</a>
