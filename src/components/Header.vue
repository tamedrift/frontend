  ...
  <header class="absolute inset-x-0 top-0 z-50">
    <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
      ...
      <div class="hidden lg:flex lg:gap-x-12">
        <router-link to="/" class="text-sm font-semibold leading-6 text-white">Home</router-link>
        <router-link to="/tiers" class="text-sm font-semibold leading-6 text-white">Tiers</router-link>
        <router-link to="/about" class="text-sm font-semibold leading-6 text-white">About</router-link>
      </div>
        ...
        <div class="mt-6 flow-root">
          <div class="-my-6 divide-y divide-gray-500/25">
            <div class="space-y-2 py-6">
              <router-link to="/"
                class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-white hover:bg-gray-800">Home</router-link>
              <router-link to="/tiers"
                class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-white hover:bg-gray-800">Tiers</router-link>
